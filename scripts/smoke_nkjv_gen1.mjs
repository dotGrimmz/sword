#!/usr/bin/env node
/**
 * Smoke-test NKJV GEN.1 from API.Bible (never prints the API key).
 */
...
const BIBLE_ID = "63097d2a0a2f7db3-01";
...
console.log(
  "preview",
  typeof content === "string" ? content.slice(0, 400) : String(content).slice(0, 400),
);
